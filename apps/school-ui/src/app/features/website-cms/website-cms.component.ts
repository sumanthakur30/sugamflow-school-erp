      ...
      .subscribe({
        next: (res) => {
          ...
          this.theme = {
            ...
            contactEmail: theme['contactEmail'] || theme['email'] || '',
            contactPhone: theme['contactPhone'] || theme['phone'] || '',
            workingHours: theme['workingHours'] || theme['hours'] || '',
            address: theme['address'] || theme['campusAddress'] || '',
            addressLine2: theme['addressLine2'] || '',
            footerBlurb: theme['footerBlurb'] || '',
