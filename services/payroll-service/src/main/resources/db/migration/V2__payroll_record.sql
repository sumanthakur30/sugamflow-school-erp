...
CREATE INDEX idx_payroll_record_org_status
    ON payroll_record (organization_id, status, updated_at DESC);

CREATE INDEX idx_payroll_record_org_created
    ON payroll_record (organization_id, created_at DESC);
