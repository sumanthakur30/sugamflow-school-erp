...
public class StaffDirectoryController {
  ...
  public StaffDirectoryController(StaffRecordService service) {
    this.service = service;
  }

  @GetMapping("/bootstrap")
  public ApiResponse<Map<String, Object>> bootstrap() {
    return ApiResponse.ok(service.directoryBootstrap());
  }
  ...
  public ResponseEntity<byte[]> exportCsv(@RequestParam Map<String, String> params) {
    ...
    return ResponseEntity.ok()
        .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"staff-directory.csv\"")
