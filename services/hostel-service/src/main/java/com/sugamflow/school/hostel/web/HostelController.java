...
import com.sugamflow.school.hostel.service.HostelRecordService;
...
public class HostelController {
  ...
  private final HostelRecordService service;

  public HostelController(HostelRecordService service) {
