...
CREATE INDEX idx_fee_collection_org_status
    ON fee_collection (organization_id, status, updated_at DESC);

CREATE INDEX idx_fee_collection_org_created
    ON fee_collection (organization_id, created_at DESC);
