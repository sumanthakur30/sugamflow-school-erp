...
CREATE INDEX idx_exam_record_org_status
    ON exam_record (organization_id, status, updated_at DESC);

CREATE INDEX idx_exam_record_org_created
    ON exam_record (organization_id, created_at DESC);
