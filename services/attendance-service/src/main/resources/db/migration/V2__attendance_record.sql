...
CREATE INDEX idx_attendance_record_org_status
    ON attendance_record (organization_id, status, updated_at DESC);

CREATE INDEX idx_attendance_record_org_created
    ON attendance_record (organization_id, created_at DESC);
