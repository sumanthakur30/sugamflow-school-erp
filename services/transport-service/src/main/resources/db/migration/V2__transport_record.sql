...
CREATE INDEX idx_transport_record_org_status
    ON transport_record (organization_id, status, updated_at DESC);

CREATE INDEX idx_transport_record_org_created
    ON transport_record (organization_id, created_at DESC);
