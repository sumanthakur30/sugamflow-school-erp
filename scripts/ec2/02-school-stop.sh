...
# Include optional profiles so phase-b + website containers are stopped too
docker compose -f "$COMPOSE_FILE" --env-file "$ENV_FILE" --profile phase-b --profile website stop
